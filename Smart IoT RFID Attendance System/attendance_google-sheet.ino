...
const String sheet_url = "https://script.google.com/macros/s/AKfycbwEwelnz5iN5IaT2HnvNmUKwbV6zOTvinmGkA0i0oVbrzcUnS7K2s2CSyZu7QlZX3GJRw/exec?=";  //Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "xxx"  //Enter WiFi Name
#define WIFI_PASSWORD "xxx"  //Enter WiFi Password
//-----------------------------------------
